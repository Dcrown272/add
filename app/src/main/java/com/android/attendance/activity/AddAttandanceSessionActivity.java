...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewProfile1=(Button)findViewById(R.id.viewProfile);
		viewProfile1.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(AddAttandanceSessionActivity.this,Profile.class);
				startActivity(intent);
			}
		});
	}
