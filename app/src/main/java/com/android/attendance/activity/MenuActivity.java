...
public class MenuActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		atten =findViewById(R.id.attendance);
		...
		atten.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(MenuActivity.this,ViewAttendanceByFacultyActivity.class);
